...
public class FullscreenActivity2 extends Activity {
    private static final String TAG_CLASS_NAME = "FullscreenActivity2";
...
//        getWindow().addFlags(WindowManager.LayoutParams.FLAG_FULLSCREEN); // 1
        getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN); // 2 is same with 1
    ...
    public void onClick(View view) {
        ...
        startActivity(new Intent(this, RealFullscreenActivity.class));
    }
}