...
public class RealFullscreenActivity extends Activity {
    private static final String TAG_CLASS_NAME = "RealFullscreenActivity";
    ...
    private void init() {
        ...
        setContentView(R.layout.activity_real_fullscreen);
    }
    ...
    public void onWindowFocusChanged(boolean hasFocus) {
        ...
        MyLog.output(TAG_CLASS_NAME, "onWindowFocusChanged", "hasFocus:" + hasFocus);
//        if (hasFocus) {
            getWindow().getDecorView().setSystemUiVisibility(View.SYSTEM_UI_FLAG_FULLSCREEN
                    | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
                    | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY
...
//        }
    ...
    public void onClick(View view) {
        ...
        button.setText("System Window");
        WindowManager.LayoutParams lp = new WindowManager.LayoutParams();
        lp.setTitle("MySystemWindow");
        lp.x = 100;
        lp.y = 200;
...
//        lp.flags = WindowManager.LayoutParams.FLAG_NOT_FOCUSABLE; // no focus will not influence status/navigation bar of activity
        lp.systemUiVisibility = View.SYSTEM_UI_FLAG_FULLSCREEN | View.SYSTEM_UI_FLAG_HIDE_NAVIGATION
                | View.SYSTEM_UI_FLAG_IMMERSIVE_STICKY
                | View.SYSTEM_UI_FLAG_LAYOUT_FULLSCREEN
                | View.SYSTEM_UI_FLAG_LAYOUT_HIDE_NAVIGATION
                | View.SYSTEM_UI_FLAG_LAYOUT_STABLE;
